...
$db['testing']['hostname'] = '104.197.251.150';
$db['testing']['username'] = 'root';
$db['testing']['password'] = '124#4Fsdfrs@';
$db['testing']['database'] = 'hero';
...
$db['production']['hostname'] = ':/cloudsql/umg-ai:us-central1:umg-ai';
$db['production']['username'] = 'root';
$db['production']['password'] = 'pass@umg';
$db['production']['database'] = 'umg_ai';
...
/*
$db['testing']['hostname'] = 'sql9.freesqldatabase.com';
$db['testing']['username'] = 'sql9195165';
$db['testing']['password'] = 'yYTkKW9gRq';
$db['testing']['database'] = 'sql9195165';
$db['testing']['dbdriver'] = 'mysql';
$db['testing']['dbprefix'] = '';
